...
class CarReqView extends StatefulWidget {
  final String cus_id;
  final String pick;
  final String drop;
  final String car_id;
  ...
  @override
  State<CarReqView> createState() => _CarReqViewState();
}

class _CarReqViewState extends State<CarReqView> {
  ...
  Future<void> fetchDataFromFirebase() async {
    try {
      ...
      // Set isLoading to false only when all data fetching is complete
      setState(() {
        isLoading = false;
      });
    } catch (e) {
  ...
  Future<void> bookingData() async {
    try {
      ...
      DocumentSnapshot<Map<String, dynamic>> bookingSnapshot =
          await FirebaseFirestore.instance.collection('car_booking').doc(widget.id).get();
  ...
  Future<void> updateStatus(String status) async {
    try {
      DocumentReference documentReference =
          FirebaseFirestore.instance.collection('car_booking').doc(widget.id);
